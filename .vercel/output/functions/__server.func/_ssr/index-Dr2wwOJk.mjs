...
function Index() {
  ...
  const navStripRef = reactExports.useRef(null);
  const heroWordsRef = reactExports.useRef(null);
  const heroCopyRef = reactExports.useRef(null);
  const ctaRef = reactExports.useRef(null);
  const floatRef = reactExports.useRef(null);
  useGsap(() => {
    const ctx = gsapWithCSS.context(() => {
      ...
      if (floatRef.current) {
        gsapWithCSS.to(floatRef.current, {
          x: 8,
          y: 8,
          duration: 5,
          ease: "sine.inOut",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { ref: heroRef, className: "relative min-h-screen flex items-center pt-32 md:pt-40 pb-20 overflow-hidden scanline", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-page relative w-full", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: navStripRef, className: "flex items-center justify-between mb-16 md:mb-24 font-mono text-[0.68rem] text-muted-foreground uppercase tracking-widest border-b border-hairline pb-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { ref: heroWordsRef, className: "display-xl tracking-tighter flex flex-col font-bold max-w-7xl leading-none", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-14 md:mt-20 grid md:grid-cols-12 gap-8 items-end border-t border-hairline pt-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: heroCopyRef, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-6 md:text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: ctaRef, className: "flex flex-wrap md:justify-end items-center gap-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: floatRef, className: "pointer-events-none absolute right-0 bottom-10 w-40 h-40 rounded-full bg-gradient-to-tr from-primary/20 to-transparent blur-3xl opacity-80" })
      ] })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "border-t border-hairline bg-surface/20 relative", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container-page py-24 md:py-36 relative z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-12 gap-12", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-8 grid sm:grid-cols-2 gap-px bg-hairline border border-hairline", children: services.map((s, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(CardReveal, { delay: idx * 80, className: "bg-background p-8 md:p-10 hover-card-premium", children: [
