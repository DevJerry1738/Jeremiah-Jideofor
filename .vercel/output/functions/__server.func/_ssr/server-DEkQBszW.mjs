...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DVzm7B_M.mjs");
...
const manifest = {
  "51496c6ca2b5055341948a46205d4083f7301883d1e1b16d00d2abd04c02d91c": {
    ...
    importer: () => import("./contact.functions-C6vxstS3.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-D4LlqYBB.mjs"),
    import("./start-DULbrvoH.mjs"),
